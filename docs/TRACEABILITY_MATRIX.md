...
| [REQ-004](requirements/REQ-004-protection.md) v1.0 | [DESIGN-004](design/DESIGN-004-protection.md) v1.0 | `src/pdftools/protection/` | `tests/unit/test_protection_*.py` | TEST-004 v1.0 | ✅ Released |
...
| [REQ-006](requirements/REQ-006-thumbnails.md) v1.0 | [DESIGN-006](design/DESIGN-006-thumbnails.md) v1.0 | `src/pdftools/thumbnails/` | `tests/unit/test_thumbnails_*.py` | TEST-006 v1.0 | ✅ Released |
